...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 25 18:50:46 2021
...
#a) Skriv coordinates metoden så att den returnerar en tupel med de interna _x och _y variablerna.
#b) Skriv neighbors metoden. Den ska returnera en lista med de 8 grannarna till cellen, alla representerade som celler (så använd Cell konstruktorn innan ni returnerar dem!).
...
class Cell:
    ...
    def neighbors(self):
        d = Cell(self.x - 1, self.y - 1)
        e = Cell(self.x - 1, self.y)
        f = Cell(self.x - 1, self.y + 1)
        g = Cell(self.x, self.y - 1)
        h = Cell(self.x, self.y + 1)
        i = Cell(self.x + 1, self.y - 1)
        j = Cell(self.x + 1, self.y)
        k = Cell(self.x + 1, self.y + 1)
...
def update(world):
    n = 1 
    duu = [ x.coordinates() for x in world]

    my_tuples1 = [Cell(i - n, j -1) for (i, j) in duu]
    my_tuples2 = [Cell(i, j - n) for (i, j) in duu]
    my_tuples3 = [Cell(i + n, j - n) for (i, j) in duu]
    my_tuples4 = [Cell(i - n, j) for (i, j) in duu]
    my_tuples5 = [Cell(i - n, j + n) for (i, j) in duu]
    my_tuples6 = [Cell(i + n, j) for (i, j) in duu]
    my_tuples7 = [Cell(i, j + n) for (i, j) in duu]
    my_tuples8 = [Cell(i + n, j + n) for (i, j) in duu]



    allnegh = my_tuples1 + my_tuples2 + my_tuples3 + my_tuples4 + my_tuples5 + my_tuples6 + my_tuples7 + my_tuples8 
    
    list_words = [ x.coordinates() for x in allnegh]
    d = {}
...
print([ x.coordinates() for x in update(block)])
print([ x.coordinates() for x in update(update(block))])
print([ x.coordinates() for x in update(update(update(block)))])
print([ x.coordinates() for x in update(update(update(block)))])
print([ x.coordinates() for x in update(update(update(update(block))))])
print("slut")
...
print([x.coordinates() for x in update(glider)])

print([x.coordinates() for x in update(update(glider))])
...
print("Returnera en lista med de 8 grannarna till cellen:")
print(c.coordinates())
print([x.coordinates() for x in c.neighbors()])
print("Skriv en funktion randomWorld. Den tar in två heltal width och height vilka representerar bredd och höjd på världen och returnerar en dict som representerar världen.")
...
#test = { Cell(x,y) : True for (x,y) in [ (26, 25), (27,25), (28,25), (32,25), (33,25), (34,25), (24,23), (29,23), (31,23), (36,23), (24,22), (29,22), (31,22), (36,22), (24,21), (29,21), (31,21), (36,21), (26,20), (27,20), (28,20), (32,20), (33,20), (34,20), (24, 18), (25,18), (26,18), (34,18), (35,18), (36,18),(18,17), (19,17), (20,17), (23,17), (28,17), (32,17), (37,17), (40,17), (41,17), (42,17), (23,16), (28,16), (32,16), (37,16), (16,15), (21,15), (23,15), (28,15), (32,15), (37,15), (39,15), (44,15), (16,14), (21,14), (39,14), (44,14), (16,13), (21,13), (24,13), (25,13), (26,13), (34,13), (35,13), (36,13), (39,13), (44,13), (18,12), (19,12), (20,12), (40,12), (41,12), (42,12), (16,11), (17,11), (18,11), (42,11), (43,11), (44,11), (10,10), (11,10), (12,10), (15,10), (20,10), (40,10), (45,10), (48,10), (49,10), (50,10), (15,9), (20,9), (40,9), (45,9), (15,8), (20,8), (40,8), (45,8), (15,7), (20,7), (40,7), (45,7), (8,6), (13,6), (15,6), (20,6), (40,6), (45,6), (47,6), (52,6), (8,5), (13,5), (47,5), (52,5),